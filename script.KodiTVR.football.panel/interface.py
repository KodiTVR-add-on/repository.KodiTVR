# -*- coding: utf-8 -*-
'''
    script.KodiTVR.football.panel - A Football Panel for Kodi
...
class Main(xbmcgui.WindowXMLDialog):
	...
	def onInit(self):
		xbmc.log(msg="[KodiTVR Football Panel] Script started", level=xbmc.LOGDEBUG)
		self.isRunning = True
		...
		while self.isRunning:
			...
			xbmc.sleep(200)
			i += 1
		xbmc.log(msg="[KodiTVR Football Panel] Script stopped", level=xbmc.LOGDEBUG)
	...
	def set_no_games(self):
		...
		if update_team_data:
			xbmc.log(msg="[KodiTVR Football Panel] Timedelta was reached for teams in league %s new request to be made..." % (str(league_id)), level=xbmc.LOGDEBUG)
			...
			xbmc.log(msg="[KodiTVR Football Panel] Using cached object for teams in league %s" % (str(league_id)), level=xbmc.LOGDEBUG)
	...
	def getLeagueTable(self):
		...
		if update_league_data:
			xbmc.log(msg="[KodiTVR Football Panel] Timedelta was reached for league %s new request to be made..." % (str(leagueid)), level=xbmc.LOGDEBUG)
			...
			xbmc.log(msg="[KodiTVR Football Panel] Using cached object for league %s" % (str(leagueid)), level=xbmc.LOGDEBUG)
		...
		if update_team_data:
			xbmc.log(msg="[KodiTVR Football Panel] Timedelta was reached for teams in league %s new request to be made..." % (str(leagueid)), level=xbmc.LOGDEBUG)
			...
			xbmc.log(msg="[KodiTVR Football Panel] Using cached object for teams in league %s" % (str(leagueid)), level=xbmc.LOGDEBUG)
		...
		for tableentry in table:
			try:
				...
				xbmc.log(msg="[KodiTVR Football Panel] Exception: %s" % (str(e)), level=xbmc.LOGDEBUG)
						...
						for id_team in id_teams:
							...
							if update_team_data:
								try:
									...
									xbmc.log(msg="[KodiTVR Football Panel] Timedelta was reached for team %s new request to be made..." % (str(id_team)), level=xbmc.LOGDEBUG)
								except: 
									teamobject = None
							else:
								teamobject = self.cache_object.getcachedTeam(id_team)
								xbmc.log(msg="[KodiTVR Football Panel] Used cached data for team %s..." % (str(id_team)), level=xbmc.LOGDEBUG)
