...
elif action == 'internationalNavigator':
    from resources.lib.indexers import international
    international.international().root()

elif action == 'internationalNext':
    from resources.lib.indexers import international
    international.international().roots(url)

elif action == 'internationalPlay':
    from resources.lib.indexers import international
    international.international().play(url)
