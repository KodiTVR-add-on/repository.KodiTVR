...
try:
    ...
    from common import add_headers, add_items, parse_url, join_url
...
if __name__ == "__main__":
    ...
    test("http://www.sportstream.pw/football6/index.html")
    test_can_handle("http://www.sportstream.pw/football6/index.html")
