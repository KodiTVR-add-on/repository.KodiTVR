...
class navigator:
    ...
    def root(self):
        self.addDirectoryItem('Tv_pt', 'tv_pt', 'channels.png', 'DefaultTvshows.png')
        ...
        self.addDirectoryItem('Tv_br', 'tv_br', 'channels.png', 'DefaultTVShows.png')
        ...
        self.addDirectoryItem('International Channels', 'internationalNavigator', 'channels.png', 'DefaultTVShows.png')
