...
class indexer:
    ...
    def tv_pt(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L21ZYkxraWNG'.decode(
                'base64')
    ...
    def tv_br(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L001bkFjeXRt'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def international(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L0FFTWV1UWJt'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def movies(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L2kzNjA1M1NT'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def kids(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L2RudkIzYW1o'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def sports(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L2tGTlhKVjN3'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def news(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L2VlUzN4Rm5M'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def all_english(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L25Ia0JuUDQ1'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def music(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L1VEeWpTaVdZ'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def hour24(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L01VdTJ1dVk5'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def theaters(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L2V3YXB0dFd3'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def pluto(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L1VmQmh5ZTEz'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def testing(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L2VyM0g1ZjZ5'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def free_clicks(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3LzJ5SnhUd1Nx'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def shows(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L1ZSVmVHUmNS'.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def rootXXX(self):
        try:
            if control.setting('Show_Adult') == 'false':
                ...
                return
            regex.clear()
            url = 'aHR0cHM6Ly9naG9zdGJpbi5jby9wYXN0ZS9kY2tjNy9yYXc='.decode(
                'base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
    ...
    def noname_list(self, url, result=None):
        try:
            ...
            try:
                ...
                fanart = '0'
            api_data = client.request(base64.b64decode('aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L1NDemtWd25Y'), timeout='5')
