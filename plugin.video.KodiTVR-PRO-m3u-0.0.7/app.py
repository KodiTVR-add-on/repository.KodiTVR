...
"""
2020 KodiTVR Full Stack Developer
...
mysettings = xbmcaddon.Addon(id = 'plugin.video.KodiTVR-PRO-m3u')
...
def m3u(m3u):
	result = "u" + "g" * 2 + "cf:" + "/" * 2 + "qy.qebcobkhfrepbagrag.pbz/f/" + m3u + ".z3h?enj=1"
...
full = m3u('cmelyude3ixutbm/XbqvGIE-CEB-z3h')
...
animacao = m3u('cmelyude3ixutbm/XbqvGIE-z3h-Navznpnb')
...
brasil = m3u('cmelyude3ixutbm/XbqvGIE-z3h-Oenfvy')
...
cameras = m3u('cmelyude3ixutbm/XbqvGIE-z3h-Pnzrenf')
...
desporto = m3u('cmelyude3ixutbm/XbqvGIE-z3h-Qrfcbegb')
...
espanha = m3u('cmelyude3ixutbm/XbqvGIE-z3h-Rfcnaun')
...
franca = m3u('cmelyude3ixutbm/XbqvGIE-z3h-Senapn')
...
italia = m3u('cmelyude3ixutbm/XbqvGIE-z3h-Vgnyvn')
...
musica = m3u('cmelyude3ixutbm/XbqvGIE-z3h-Zhfvpn')
...
portugal = m3u('cmelyude3ixutbm/XbqvGIE-z3h-Cbeghtny')
...
usa = m3u('cmelyude3ixutbm/XbqvGIE-z3h-HFN')
...
temp = m3u('cmelyude3ixutbm/XbqvGIE-z3h-Grzc')
...
radios = m3u('cmelyude3ixutbm/XbqvGIE-z3h-Enqvbf')
...
world = m3u('cmelyude3ixutbm/XbqvGIE-z3h-jbeyq')
